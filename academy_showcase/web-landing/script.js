...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const lessonData = {
        mac: [
            { title: "1. Clone Repository", desc: "Download the Terminal Academy engine.", cmd: "git clone https://github.com/888ank888/terminal-academy", out: "Cloning into 'terminal-academy'...\nResolving deltas: 100% (142/142), done." },
            { title: "2. Enter Workspace", desc: "Navigate to the project directory.", cmd: "cd terminal-academy", out: "" },
